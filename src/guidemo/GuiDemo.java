...
public class GuiDemo extends JFrame{
	...
	public GuiDemo() {
		...
		drawPanel.getTextItem().setText("There is a first time for "
				+ "Everything.");
    ...
    private class ChooseBackgroundAction extends AbstractAction {
    	...
    	ChooseBackgroundAction(String text) {
    		...
    		if (text.equals("Color...")) {
    			...
    			g.fillRect((32/5), 0, (32/5)+5, 32);
    			g.setColor(Color.YELLOW);
    			g.fillRect((32/5)+5, 0, (32/5)+10, 32);
    			g.setColor(Color.GREEN);
    			g.fillRect((32/5)+10, 0, (32/5)+15, 32);
    			g.setColor(Color.BLUE);
    			g.fillRect((32/5)+15, 0, (32/5)+20, 32);
    			g.setColor(Color.MAGENTA);
    			g.fillRect((32/5)+20, 0, (32/5)+25, 32);
    			g.dispose();
    			...
    			putValue(Action.SHORT_DESCRIPTION, "<html>Select an image file.</html>");
